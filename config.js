...
export const TRANSLATIONS = {
  de: {
    ...
    zoom: 'Zoom',
    resultLabel: 'Automatische Vorschau:',
    buyBtn: (price) => `Jetzt bestellen — ${price}`,
    regenerate: 'Vorschau nochmal erstellen',
    ...
    loadingSteps: ['Foto wird vorbereitet', 'Vorschau wird generiert', 'Details werden verfeinert', 'Fast fertig'],
    loadingUpsell: () => 'Diese Vorschau wird automatisch erstellt. Für ein echtes handgezeichnetes Original — von echten Künstlern.',
  ...
  en: {
    ...
    cropCancel: 'Cancel',
    zoom: 'Zoom',
    resultLabel: 'Automatic preview:',
    buyBtn: (price) => `Order now — ${price}`,
    regenerate: 'Create another preview',
    ...
    loadingSteps: ['Preparing photo', 'Generating preview', 'Refining details', 'Almost done'],
    loadingUpsell: () => 'This preview is generated automatically. For a real hand-drawn original — by real artists.',
