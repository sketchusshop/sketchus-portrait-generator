...
import { SHOP_CONFIG, AI_PROMPT } from '../../config';
...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Checkout URL — gắn ảnh vào LINE ITEM PROPERTIES
    // Hiện trong đơn hàng Shopify, KHÔNG phải order note
    const params = new URLSearchParams();
    params.append('properties[🖼 Bleistift-Portrait]', aiBlob.url);
    if (originalBlobUrl) params.append('properties[📷 Originalfoto]', originalBlobUrl);
